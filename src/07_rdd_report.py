...
<h2>Motivation</h2>
<p>
  Fun fact about me: I love reviews. I have a near-religious obsession with online review aggregators &mdash;
...
<p>
  The &ldquo;Fresh&rdquo; vs. &ldquo;Rotten&rdquo; label creates a sharp cutoff at 60% &mdash; which
  ...
  Their paper was interesting, but I wanted to see if things looked different in the post-COVID era &mdash;
...
<ul class="findings">
  ...
  0.060 log points (<i>p</i>&nbsp;=&nbsp;0.82) with controls &mdash; statistically and economically
  ...
  significant, but that vanishes once you add controls or allow for a quadratic &mdash; classic
  ...
  Not so much &mdash; or at least not enough to pick up in 621 films.</li>
</ul>
